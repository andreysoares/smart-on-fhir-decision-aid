...
function decisionAids() {
  if(typeof p.deceaseddate === 'undefined'){
    $('#tools').html(`<div class="page-header">
    ...
    <div class="col-sm-3">
      <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-primary" id="ICDButton" onClick="ICDTools()">Let\'s Start</button>
        </div>
      </div>
    </div>
    <div class="col-sm-3">
  ...
  `);
    ...
    $('#tools').html(`<div>&nbsp;</div>
    <div class="alert alert-warning"><h1>Patient is deceased!</h1></div>
    `);
  }
}
...
<button type="button" class="btn btn-primary" onClick="ICDTools()">Back</button>
</div>
`);
}
...
$('#ok-event').on('click', function (evt) {
  console.log('triggered');
  decisionAids();
});

$('#ICDButton').on('click', function (e) {
  console.log('ICDTools');
  ICDTools();
});
